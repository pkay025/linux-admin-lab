...
![Current Location](screenshots/01-current-location-and-listing.png)

### Root Directory Exploration

![Root Directory](screenshots/02-root-directory.png)

### System Administrator Workspace

![Workspace](screenshots/03-system-admin-workspace.png)
